function drawBuildingK(Blds, BldTypes, U)
% Version K: Drawing buildings with K-1 types of obstacles
%
...
for ib = 1:Nbld
    ...
    plot(Lines(Nlines, [1 3]), Lines(Nlines, [2 4]), '-', 'LineWidth', 2, 'color', bldColor);
    hold off
    ...
    for x1 = L:st:(R + bH)
        ...
        hold on
        if length(I) > 1
            plot(T.intMatrixX(1, I(1:2)), T.intMatrixY(1, I(1:2)), '--', ...
                 'LineWidth', 1, 'color', bldColor);
        end
        hold off
    end
