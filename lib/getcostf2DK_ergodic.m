function f = getcostf2DK_ergodic(PosUAV, PosUE, PosBS, los, U, fun1, fun2)
% Version _ergodic: This versio only works for K=2 segment case.
% Demonstrating Ergodic capacity suggested by the reviewer.
%
...
%   Rerg:   Ergodic capacity with 3 rows: AWGN, Rician (K-factor = 9dB),
%           Rayleigh capacity. Each row represent the capacity evaluated
%           over SNRs specified by SNRs_dB
%
% OUTPUT
...
% NOTE: Assume user height = 0.
    ...
    lopt = lmin;
    f = fl(lopt, rho, theta, L, h, Hb, U, fun1, fun2, los);

end

function f = fl(l, rho, theta, L, h, Hb, U, fun1, fun2, los)
